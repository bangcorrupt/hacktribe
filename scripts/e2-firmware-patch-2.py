...
def main():
    ...
    sd_path = ''
    synth_sd_path = 'KORG/electribe/System/SYSTEM.VSB'
    sampler_sd_path = 'KORG/electribe sampler/System/SYSTEM.VSB'
    hack_sd_path = 'KORG/hacktribe/System/SYSTEM.VSB'
   ...
   # else:
    ...
    with open ("hash/modified-hacked-SYSTEM.VSB.sha", "r") as f:
        synth_targ_hash=f.readlines()[0].split()[0]       

    with open ("hash/hacked-SYSTEM.VSB.sha", "r") as f:
        sampler_targ_hash=f.readlines()[0].split()[0]
    ...
    print('Patching firmware for synth...\n')
    dst_path = 
